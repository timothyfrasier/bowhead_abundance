###################################################
#                 markrecapsim_2missing           #
#                                                 #
# A function for simulating mark-recapture data   #
# for individuals from 4 different, partially     #
# overlapping, "populations" where two            #
# unsampled "populations" also exists.            #
#                                                 #
#                       by                        #
#                  Tim Frasier                    #
#                  05-Apr-2019                    #
...
markrecapsim <- function (nPop1, nPop2, nPop3, nPop4, nPop5, nPop6, pop1Samp1, pop2Samp1, pop3Samp1, pop4Samp1, m12, m13, m14, m15, m16, m23, m24, m25, m26, m34, m35, m36, m45, m46, m56, pop1Samp2, pop2Samp2, pop3Samp2, pop4Samp2) {
  ...
  nMigrants16 <- round(min((nPop1 * m16), (nPop6 * m16)))
	nMigrants1 <- sum(nMigrants12, nMigrants13, nMigrants14, nMigrants15, nMigrants16)
	if (nMigrants12 > 0) { 
  ...
  if (nMigrants15 > 0) {
	...
	if (nMigrants16 > 0) {
	  pop61 <- pop1mix[(nMigrants12 + nMigrants13 + nMigrants14 + nMigrants15 + 1):(nMigrants12 + nMigrants13 + nMigrants14 + nMigrants15 + nMigrants16)]
	} else {
	  pop61 <- 0
	}
  ...
  nMigrants26 <- round(min((nPop2 * m26), (nPop6 * m26)))
	nMigrants2 <- sum(nMigrants12, nMigrants23, nMigrants24, nMigrants25, nMigrants26)
	if (nMigrants12 > 0) { 
  ...
  if (nMigrants25 > 0) {
	...
	if (nMigrants26 > 0) {
	  pop62 <- pop2mix[(nMigrants12 + nMigrants23 + nMigrants24 + nMigrants25 + 1):(nMigrants12 + nMigrants23 + nMigrants24 + nMigrants25 + nMigrants26)]
	} else {
	  pop62 <- 0
	}
  ...
  nMigrants36 <- round(min((nPop3 * m36), (nPop6 * m36)))
	nMigrants3 <- sum(nMigrants13, nMigrants23, nMigrants34, nMigrants35, nMigrants36)
	if (nMigrants13 > 0) { 
  ...
  if (nMigrants35 > 0) {
    pop53 <- pop3mix[(nMigrants13 + nMigrants23 + nMigrants34 + 1):(nMigrants13 + nMigrants23 + nMigrants34 + nMigrants35)]
  } else {
    pop53 <- 0
  }
	if (nMigrants36 > 0) {
	  pop63 <- pop3mix[(nMigrants13 + nMigrants23 + nMigrants34 + nMigrants35 + 1):(nMigrants13 + nMigrants23 + nMigrants34 + nMigrants35 + nMigrants36)]
	} else {
	  pop63 <- 0
	}
  ...
  nMigrants46 <- round(min((nPop4 * m46), (nPop6 * m56)))
	nMigrants4 <- sum(nMigrants14, nMigrants24, nMigrants34, nMigrants45, nMigrants46)
	if (nMigrants14 > 0) { 
  ...
  if (nMigrants45 > 0) {
	...
	if (nMigrants46 > 0) {
	  pop64 <- pop4mix[(nMigrants14 + nMigrants24 + nMigrants34 + nMigrants45 + 1):(nMigrants14 + nMigrants24 + nMigrants34 + nMigrants45 + nMigrants46)]
	} else {
	  pop64 <- 0
	}
  ...
  #---From Pop5---#
  nMigrants56 <- round(min((nPop5 * m56), (nPop6 * m56)))
  nMigrants5 <- sum(nMigrants15, nMigrants25, nMigrants35, nMigrants45, nMigrants56)
  if (nMigrants15 > 0) {
  ...
  if (nMigrants56 > 0) {
    pop65 <- pop5mix[(nMigrants15 + nMigrants25 + nMigrants35 + nMigrants45 + 1):(nMigrants15 + nMigrants25 + nMigrants35 + nMigrants45 + nMigrants56)]
  } else {
    pop65 <- 0
  }
  ...
  #---From Pop6---#
  nMigrants6 <- sum(nMigrants16, nMigrants26, nMigrants36, nMigrants46, nMigrants56)
  if (nMigrants16 > 0) {
    pop16 <- pop6mix[1:nMigrants16]
  } else {
    pop16 <- 0
  }
  if (nMigrants26 > 0) {
    pop26 <- pop6mix[(nMigrants16 + 1):(nMigrants16 + nMigrants26)]
  } else {
    pop26 <- 0
  }
  if (nMigrants36 > 0) {
    pop36 <- pop6mix[(nMigrants16 + nMigrants26 + 1):(nMigrants16 + nMigrants26 + nMigrants36)]
  } else {
    pop36 <- 0
  }
  if (nMigrants46 > 0) {
    pop46 <- pop6mix[(nMigrants16 + nMigrants26 + nMigrants36 + 1):(nMigrants16 + nMigrants26 + nMigrants36 + nMigrants46)]
  } else {
    pop46 <- 0
  }
  if (nMigrants56 > 0) {
    pop56 <- pop6mix[(nMigrants16 + nMigrants26 + nMigrants36 + nMigrants46 + 1):(nMigrants16 + nMigrants26 + nMigrants36 + nMigrants46 + nMigrants56)]
  } else {
    pop56 <- 0
  }
  pop66 <- pop6mix[(nMigrants6 + 1):nPop6]

	#---Merge Data and Shuffle---#
	pop1new <- c(pop11, pop12, pop13, pop14, pop15, pop16)
	pop1new <- sample(pop1new, nPop1, replace = FALSE)

	pop2new <- c(pop21, pop22, pop23, pop24, pop25, pop26)
	pop2new <- sample(pop2new, nPop2, replace = FALSE)

	pop3new <- c(pop31, pop32, pop33, pop34, pop35, pop36)
	pop3new <- sample(pop3new, nPop3, replace = FALSE)
	
	pop4new <- c(pop41, pop42, pop43, pop44, pop45, pop46)
	pop4new <- sample(pop4new, nPop4, replace = FALSE)
	
  pop5new <- c(pop51, pop52, pop53, pop54, pop55, pop56)
  pop5new <- sample(pop5new, nPop5, replace = FALSE)
  
  pop6new <- c(pop61, pop62, pop63, pop64, pop65, pop66)
  pop6new <- sample(pop6new, nPop6, replace = FALSE)
  ...
  for (marked in 1:pop4Samp2) {
    ...
    #--- Pop1 & 2 ---#
    #--- Recaptures will be all individuals with sighting histories > 10 or 20 ---#
